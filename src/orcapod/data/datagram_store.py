# class DatagramStore(Protocol):
#     def record_datagram(
#         self,
#         record_path: tuple[str, ...],
#         datagram: dp.Datagram,
...
#     def get_recorded_datagram(
#         self,
#         record_path: tuple[str, ...],
#         record_id: str,
#     ) -> dp.Datagram | None: ...

#     def get_all_records(self, record_path: tuple[str, ...]) -> dp.Stream | None:
...
#     ) -> pl.DataFrame | None:
#         """Retrieve all records for a given path as a Polars stream."""
#         ...

#     def get_records_by_ids(
#         self,
#         record_path: tuple[str, ...],
#         entry_ids: Collection[str],
...
from orcapod.data.datagrams import ArrowDatagram, SemanticTypeRegistry
